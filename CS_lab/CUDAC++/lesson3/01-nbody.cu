...
int main(const int argc, const char** argv) {
  ...
  size_t threadsPerB = 256;
  size_t numofB = 32 * numberOfSMs;
   ...
   */
    ...
    bodyForce<<<threadsPerB , numofB , 0 , stream>>>(p, dt, nBodies); // compute interbody forces
